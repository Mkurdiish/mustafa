...
install() {
reset
echo -e "\e[38;5;77m • Welcome to Source Mustafa - اهلا بك في سورس مصطفى كردي •\e[0m"
echo -e "\e[38;5;77m      •{ Setting up offices - جاري رفع المكاتب } •\e[0m"
echo -e "\e[38;5;77m • Installing Source Mustafa - جاري تحميل سورس مصطفى كردش •\e[0m"
...
reset
echo -e "\e[38;5;77m • Installing Source Mustafa - جاري تحميل سورس مصطفى كردي •\e[0m"
...
reset
echo -e "\e[38;5;77m • Installing Source Mustafa - جاري تحميل سورس مصطقى كردش •\e[0m"
...
echo -e "\e[38;5;77m    |-------------------------------------------|\e[0m"
echo -e "\e[38;5;77m    |This Source Was Developed By (alone) @alone_kurdish.|\e[0m"
echo -e "\e[38;5;77m    |  This Is The Source Channel @tweakjailbreak .   |\e[0m"
echo -e "\e[38;5;77m    |               - Mustafa -                 |\e[0m"
echo -e "\e[38;5;77m    ---------------------------------------------\e[0m"
cd ..
rm -rf luarocks*
./tg -s DevProx.lua
