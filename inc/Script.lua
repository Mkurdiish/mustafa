...
bd = '🙋🏻‍♂╿العضو ['..USERNAME..'](tg://user?id='..msg.sender_user_id_..') \n📌╽لأستخدام البوت عليك الاشتراك ب قناة السورس @tweakjailbreak'
...
local inline = {{{text="⚜│قناه السـورس ضـغـط هنا ",url="t.me/tweakjaipbreak"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : جلبريك](tweakjailbreak)',nil,inline,msg.id_)
return false
end
