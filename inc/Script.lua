...
return sendMsg(msg.chat_id_,msg.id_,"المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "alone_kurdish"))
end
end
...
if redis:sismember(amrko..':Malk_Group:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  »「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(amrko..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(amrko..':Malk_Group:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(amrko..':Malk_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  »「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(amrko..'username:'..UserID,'username',UserName)
redis:sadd(amrko..':Malk_Group:'..arg.ChatID,UserID)
...
if UserID == 706097010 or UserID == 706097010 then return sendMsg(msg.chat_id_,msg.id_,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس مصطفى يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : مصطفى 🍃",url="t.me/alone_kurdish"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : مصطفى](t.me/alone_kurdish)',nil,inline,msg.id_)
return false
end
...
if msg.forward_info_ or msg.content_.ID == "MessageUnsupported" or msg.content_.ID == "MessageDocument" then
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرآ لآ يمـكنك آرسـآل {ملف , توجيه‌‏ , فديو كآم} ❗️")
end
SUDO_USER = redis:hgetall(amrko..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "\n🏌 "..SUDO_USER
