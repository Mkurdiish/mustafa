...
print(CmdSitting)
if CmdSitting then
local ResRedis =  redis:del(amrko..CmdSitting..msg.chat_id_)
...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"ليس لديك صلاحية التحكم الادمن , ارجو المعذرة ❤️",true) end
if ResRedis == 0 then redis:set(amrko..CmdSitting..msg.chat_id_,true) end
...
[{"text": "م3","callback_data": "List3"},{"text": "اوامر الأعضاء","callback_data": "List5"}],
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التعديل » '..(redis:get(amrko..'lock_edit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_edit"},'
..'{"text": " الروابط » '..(redis:get(amrko..'lock_link'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_link"}],'

..'[{"text": " التاك » '..(redis:get(amrko..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_tag"},'
..'{"text": " المعرفات » '..(redis:get(amrko..'lock_username'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_username"}],'

..'[{"text": " التكرار » '..(redis:get(amrko..'lock_flood'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_flood"},'
..'{"text": " الكلايش » '..(redis:get(amrko..'lock_spam'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_spam"}],'

..'[{"text": " الويب » '..(redis:get(amrko..'lock_webpage'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_webpage"},'
..'{"text": " الماركدوان » '..(redis:get(amrko..'lock_markdown'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_markdown"}],'

..'[{"text": " البوتات بالطرد » '..(redis:get(amrko..'lock_bots_by_kick'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots_by_kick"},'
..'{"text": " البوتات » '..(redis:get(amrko..'lock_bots'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots"}],'

..'[{"text": " الاضافه » '..(redis:get(amrko..'lock_Add'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_Add"},'
..'{"text": " الاشعارات » '..(redis:get(amrko..'mute_tgservice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_tgservice"}],'

..'[{"text": " الفشار » '..(redis:get(amrko..'lock_mmno3'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_mmno3"},'
..'{"text": " الفارسيه » '..(redis:get(amrko..'lock_pharsi'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_pharsi"}],'

..'[{"text": " الانكليزيه » '..(redis:get(amrko..'lock_lang'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_lang"},'
..'{"text": " التوجيه » '..(redis:get(amrko..'mute_forward'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_forward"}],'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " المتحركه » '..(redis:get(amrko..'mute_gif'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_gif"},'
..'{"text": " الدردشه » '..(redis:get(amrko..'mute_text'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_text"}],'

..'[{"text": " الانلاين » '..(redis:get(amrko..'mute_inline'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_inline"},'
..'{"text": " الالعاب » '..(redis:get(amrko..'mute_game'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_game"}],'

..'[{"text": " الصور » '..(redis:get(amrko..'mute_photo'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_photo"},'
..'{"text": " الفيديو » '..(redis:get(amrko..'mute_video'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_video"}],'

..'[{"text": " الصوت » '..(redis:get(amrko..'mute_audio'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_audio"},'
..'{"text": " البصمات » '..(redis:get(amrko..'mute_voice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_voice"}],'

..'[{"text": " الملصقات » '..(redis:get(amrko..'mute_sticker'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_sticker"},'
..'{"text": " الجهات » '..(redis:get(amrko..'mute_contact'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_contact"}],'

..'[{"text": " الموقع » '..(redis:get(amrko..'mute_location'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_location"},'
..'{"text": " الملفات » '..(redis:get(amrko..'mute_document'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_document"}],'
..'[{"text": "- رجوع » ","callback_data": "CmdBack1"},{"text": "- اخفاء الامر","callback_data": "LoginOut"}]'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " الايدي » '..(redis:get(amrko..'lock_id'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_id"},'
..'{"text": " التاك للكل » '..(redis:get(amrko..'lock_takkl'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_takkl"}],'

..'[{"text": " الترحيب » '..(redis:get(amrko..'welcome:get'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#welcome:get"},'
..'{"text": " الردود » '..(redis:get(amrko..'replay'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#replay"}],'

..'[{"text": " الردود العشوائيه » '..(redis:get(amrko..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_tag"},'
..'{"text": " التحذير » '..(redis:get(amrko..'lock_woring'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_woring"}],'

..'[{"text": " تاك » '..(redis:get(amrko..'lock_RandomRdod'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_RandomRdod"},'
..'{"text": " الرابط » '..(redis:get(amrko..'lock_linkk'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_linkk"}],'

..'[{"text": " المغادره » '..(redis:get(amrko..'lock_leftgroup'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_leftgroup"},'
..'{"text": " الحظر » '..(redis:get(amrko..'lock_KickBan'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_KickBan"}],'

..'[{"text": " الحمايه » '..(redis:get(amrko..'antiedit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#antiedit"},'
..'{"text": " الايدي بالصوره » '..(redis:get(amrko..'idphoto'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#idphoto"}],'

..'[{"text": " التحقق » '..(redis:get(amrko..'lock_check'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_check"},'
..'{"text": " التنظيف التلقائي » '..(redis:get(amrko..'lock_cleaner'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_cleaner"}],'
...
print(download_file('https://raw.githubusercontent.com/alone_kurdish/iosbot/master/plugins/games.lua','./plugins/games.lua'))
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███         |') end
print(download_file('https://raw.githubusercontent.com/alone_kurdish/iosbot/master/inc/Run.lua','./inc/Run.lua'))
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
print(download_file('https://raw.githubusercontent.com/alone_kurdish/iosbot/master/inc/locks.lua','./inc/locks.lua'))
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
print(download_file('https://raw.githubusercontent.com/alone_kurdish/iosbot/master/inc/Script.lua','./inc/Script.lua'))
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
print(download_file('https://raw.githubusercontent.com/alone_kurdish/iosbot/master/inc/functions.lua','./inc/functions.lua'))
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(amrko..":NameBot:") or "الزعيم"
...
Fshar_Word , res = https.request('https://api.th3amrko.com/Words_Fshars.txt')
...
result = false
if msg.sender_user_id_ == 706097010 or msg.sender_user_id_ == 706097010 then 
SudoBase = true
...
local res = https.request("http://api.th3amrko.com/CheckUser/?User="..User)
...
local list = redis:smembers(amrko..'bannedpv')
if #list==0 then return "- قائمة المحظورين فارغة " end
message = '-قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
local info = redis:hgetall(amrko..'username:'..v)
...
if redis:get(amrko..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'- المجموعه بالتاكيد ✓️ تم تفعيلها \n- بواسطه »「 '..NameUser..' 」 \n') end
...
return sendMsg(msg.chat_id_,msg.id_,"- آشـترك بآلقنآ‌‏هہ آولآ ["..UserChaneel.."] \n- ثم آرجع آرسـل تفعيل .")
end
else
return "- آشـترك بآلقنآ‌‏هہ آولآ ["..UserChaneel.."] \n- ثم آرجع آرسـل تفعيل ."
end
end
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(amrko..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(amrko..':Malk_Group:'..arg.chat_id_,data.id_)
...
if cmd == "UpMalk" then
if redis:sismember(amrko..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  »「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعه ✓") 
end
redis:hset(amrko..'username:'..UserID,'username',USERNAME)
redis:sadd(amrko..':Malk_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  »「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعه ✓") 
end

if cmd == "DwnMalk" then
if not redis:sismember(amrko..':Malk_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"- المستخدم  »「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعه ✓") 
end
redis:srem(amrko..':Malk_Group:'..ChatID,UserID) 
...
if UserID == 706097010 or UserID == 706097010 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ❕") end

if UserID == SUDO_ID then 
rinkuser = 1
elseif redis:sismember(amrko..':SUDO_BOT:',UserID) then 
rinkuser = 2
elseif redis:sismember(amrko..':Malk_Group:'..msg.chat_id_,UserID) then 
rinkuser = 3
elseif redis:sismember(amrko..':MONSHA_Group:'..ChatID,UserID) then 
rinkuser = 4
elseif redis:sismember(amrko..':MONSHA_BOT:'..ChatID,UserID) then 
