------------------------------------------------
-- This Source Was Developed By (alone) @alone_kurdish.--
--   This Is The Source Channel @tweakjailbreak .   --
--                - Mustafa -                 -- 
...
--     Start Functions    --
----------Bot Owner---------
function is_leader(msg) local var = false if msg.sender_user_id_ == tonumber(DevId) then var = true end if msg.sender_user_id_ == tonumber(1360161611) then var = true end return var end 
function is_leaderid(user_id) local var = false if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------  Sudo  ----------
function is_sudo(msg) local var = false for k,v in pairs(sudo_users) do if msg.sender_user_id_ == v then var = true end end if msg.sender_user_id_ == tonumber(DevId) then var = true end if msg.sender_user_id_ == tonumber(1360161611) then var = true end return var end
function is_sudoid(user_id) local var = false for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------  SudoBot  ---------
function is_SudoBot(user_id)
local var = false local absb = 'abs:SudoBot:' local SudoBot = DevAbs:sismember(DevProx..absb, user_id)
if SudoBot then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------Owner all---------
...
if ownerall then var = true end if SudoBot then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------admin all---------
...
if adminall then var = true end if SudoBot then var = true end if ownerall then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
------ VIP MEMBER ALL ------
...
if vpall then var = true end if ownerall then var = true end if SudoBot then var = true end if adminall then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------  donky  ---------
...
if donky then var = true end if admins then var = true end if owner then var = true end if SudoBot then var = true end if absmonsh then var = true end if monsh then var = true end if ownerall then var = true end if adminall then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------  absmonsh  ---------
...
if absmonsh then var = true end if SudoBot then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------  monsh  ---------
...
if monsh then var = true end if SudoBot then var = true end if absmonsh then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
---------  monshid  ---------
...
if monshid then var = true end if SudoBot then var = true end if absmonsh then var = true end if monsh then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------  Owner  ---------
...
if owner then var = true end if SudoBot then var = true end if absmonsh then var = true end if monsh then var = true end if monshid then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
----------  admin  ---------
...
if admins then var = true end if owner then var = true end if SudoBot then var = true end if absmonsh then var = true end if monsh then var = true end if ownerall then var = true end if monshid then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
---------VIP MEMBER---------
...
if vipmem then var = true end if admins then var = true end if owner then var = true end if SudoBot then var = true end if absmonsh then var = true end if monsh then var = true end if ownerall then var = true end if adminall then var = true end if monshid then var = true end for k,v in pairs(sudo_users) do if user_id == v then var = true end end if user_id == tonumber(DevId) then var = true end if user_id == tonumber(1360161611) then var = true end return var end
--     Source DevProx     --
...
local id_rank = function(msg) if tonumber(msg.sender_user_id_) == tonumber(1360161611) then ABS_PROX = 'مبرمج السورس' elseif is_leader(msg) then ABS_PROX = 'المطور الاساسي' elseif is_SudoBot(msg.sender_user_id_) then ABS_PROX = 'مطور البوت' elseif is_ownerall(msg.sender_user_id_) then ABS_PROX = 'المدير العام' elseif is_adminall(msg.sender_user_id_) then ABS_PROX = 'الادمن العام' elseif is_vipall(msg.sender_user_id_) then ABS_PROX = 'المميز العام' elseif is_absmonsh(msg.sender_user_id_, msg.chat_id_) then ABS_PROX = 'منشئ المجموعة' elseif is_monsh(msg.sender_user_id_, msg.chat_id_) then ABS_PROX = 'المنشئ الاساسي' elseif is_monshid(msg.sender_user_id_, msg.chat_id_) then ABS_PROX = 'المنشئ' elseif is_owner(msg.sender_user_id_, msg.chat_id_) then ABS_PROX = 'المدير' elseif is_admin(msg.sender_user_id_, msg.chat_id_) then ABS_PROX = 'الادمن' elseif is_vipmem(msg.sender_user_id_, msg.chat_id_) then ABS_PROX = 'عضو مميز' elseif is_donky(msg.sender_user_id_, msg.chat_id_) then ABS_PROX = 'عضو مرتب 😹💔' else ABS_PROX = 'فقط عضو' end return ABS_PROX end
function rank_abs(user_id,chat_id) if tonumber(user_id) == tonumber(1360161611) then ABS_PROX  = "المبرمج" elseif is_leaderid(user_id) then ABS_PROX  = "المطور" elseif is_sudoid(user_id) then ABS_PROX = "المطور" elseif is_SudoBot(user_id) then ABS_PROX = "المطور" elseif is_ownerall(user_id) then ABS_PROX = "المدير" elseif is_adminall(user_id) then ABS_PROX = "الادمن" elseif is_absmonsh(user_id, chat_id) then ABS_PROX = "المنشئ" elseif is_monsh(user_id, chat_id) then ABS_PROX = "المنشئ" elseif is_monshid(user_id, chat_id) then ABS_PROX = "المنشئ" elseif is_owner(user_id, chat_id) then ABS_PROX = "المدير" elseif is_admin(user_id, chat_id) then ABS_PROX = "الادمن" else ABS_PROX = "العضو" end return ABS_PROX end
--     Source DevProx     --
--       Set SudoBot        --
...
if is_leader(msg) then 
local Sudo_Welcome = '*⌁ ︙ اهلا بك مجددا عزيزي المطور *\n*⌁ ︙ اليك الازرار الخاصه بتعديل وتغيير كلايش سورس مصطفى الكردش فقط اضغط على الامر الذي تريد تنفيذه*'
local key = {
{'تعيين امر الاوامر'},
...
Text = '📬│تم آرسـآل آلرسـآل‌‏هہ 🌿\n🎟│آلى : 🏌🏻'
elseif msg.content_.ID == 'MessageSticker' then    
sendSticker(id_user, msg.id_, 0, 1,nil, msg.content_.sticker_.sticker_.persistent_id_)   
Text = '📬│تم آرسـآل الملصق 🌿\n🎟│آلى : 🏌🏻'
elseif msg.content_.ID == 'MessagePhoto' then    
sendPhoto(id_user, msg.id_, 0, 1,nil, msg.content_.photo_.sizes_[0].photo_.persistent_id_,(msg.content_.caption_ or ''))    
Text = '📬│تم آرسـآل الصورة 🌿\n🎟│آلى : 🏌🏻'
elseif msg.content_.ID == 'MessageAnimation' then    
sendDocument(id_user, msg.id_, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_)    
Text = '📬│تم آرسـآل المتحركه 🌿\n🎟│آلى : 🏌🏻'
elseif msg.content_.ID == 'MessageVoice' then    
sendVoice(id_user, msg.id_, 0, 1,nil, msg.content_.voice_.voice_.persistent_id_)    
Text = '📬│تم آرسـآل البصمه 🌿\n🎟│آلى : 🏌🏻'
end     
...
Dev_Abs(tostring((DevAbs:get(DevProx.."bot:leader:gr") or DevId)), 0, 1, "⚜️│ تــــم تــفــعــيــل الـــبـــوت ... \n┄─┅═ـ═┅─┄\n🎟│الـمعرف ❨ @"..(result.username_ or "لا يوجد").." ❩\n┄─┅═ـ═┅─┄\n📑╿معلومات المجموعه \n┄─┅═ـ═┅─┄\n🗯│اسم المجموعه ❨ "..f2.title_.." ❩\n📛│ايدي المجموعه \n❨ "..msg.chat_id_.." ❩\n📎│رابط المجموعه \n❨ "..(t2.invite_link_ or "لايوجد").." ❩\n┄─┅═ـ═┅─┄\n⏱╽الساعه "..os.date("%I:%M%p").." \n📆│تاريخ التفعيل "..os.date("%Y/%m/%d").."" , 1, 'html') 
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID
...
--     Source DevProx     --
if text == 'جلب نسخه القروبات' or text == 'النسخه الاحتياطيه' or text == 'نسخه القروبات' and tonumber(msg.sender_user_id_) == tonumber(DevId) then
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..DevProx..'.json', '⌁︙عدد قروبات البوت : ('..#list..')',dl_cb, nil)
end
...
DevAbs:set(DevProx..abs, glink)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ رابط قروب الدعم الجديد ", 1, "md")
...
--     Source DevProx     --
if text == 'بوت' or text == 'بوتت' then name_bot = (DevAbs:get('ABS_PROX:'..bot_id..'name_bot') or 'بروكس') local ABS_PROX = {  " اسمي "..name_bot.." 🥺",  "اذا تقول بوت افجر راسك 💥😹 ",  "نادني "..name_bot.." ياروحي 🌹",  " بوت بعينك يا تبن 🙂", } DevAbs2 = math.random(#ABS_PROX) Dev_Abs(msg.chat_id_, msg.id_, 1, ABS_PROX[DevAbs2] , 1, 'md') end
...
if (text and text == (DevAbs:get('ABS_PROX:'..bot_id..'name_bot') or 'بروكس')) then name_bot = (DevAbs:get('ABS_PROX:'..bot_id..'name_bot') or 'بروكس') local namebot = {  ' هلا قلب '..name_bot..' تفضل🌷',  'عيونه 🌸',  'يا بعد '..name_bot..' امرني♥️',  'امرني قلبي لك 💝 ' } name = math.random(#namebot) Dev_Abs(msg.chat_id_, msg.id_, 1, namebot[name] , 1, 'md') return false end
--     Source DevProx     --
...
name = string.gsub(name,'ضراطه','الي يسوق العضو يتحمل ___ ')
...
⌁︙ارسل ↫ ( انكليزيه ) للعب
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[@alone_kurdish](https://t.me/alone_kurdish)
]], 1, 'md')
end
end
--     Source DevProx     --
...
if result.id_ then if tonumber(result.sender_user_id_) == tonumber(1360161611) then DeveAbs = 'مبرمج السورس' elseif tonumber(result.sender_user_id_) == tonumber(DevId) then DeveAbs = 'المطور الاساسي' elseif is_sudoid(result.sender_user_id_) then DeveAbs = "المطور الثانوي" elseif is_SudoBot(result.sender_user_id_, msg.chat_id_) then DeveAbs = "مطور البوت" elseif is_ownerall(result.sender_user_id_) then DeveAbs = "المدير العام" elseif is_adminall(result.sender_user_id_) then DeveAbs = "الادمن العام" elseif is_vipall(result.sender_user_id_) then DeveAbs = "المميز العام" elseif is_absmonsh(result.sender_user_id_, msg.chat_id_) then DeveAbs = "منشئ المجموعة" elseif is_monsh(result.sender_user_id_, msg.chat_id_) then DeveAbs = "المنشئ الاساسي" elseif is_monshid(result.sender_user_id_, msg.chat_id_) then DeveAbs = "المنشئ" elseif is_owner(result.sender_user_id_, msg.chat_id_) then DeveAbs = "المدير" elseif is_admin(result.sender_user_id_, msg.chat_id_) then DeveAbs = "الادمن" elseif is_vipmem(result.sender_user_id_, msg.chat_id_) then DeveAbs = "عضو مميز" elseif is_donky(result.sender_user_id_, msg.chat_id_) then DeveAbs = "عضو مرتب 😹💔" else DeveAbs = "فقط عضو" end end
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙رتبته بالبوت ↫ '..DeveAbs..'\n⌁︙موقعه بالقروب ↫ '..rank_gps , 1, 'md') 
end,nil)
end
...
--     Source DevProx     --
if text:match("^القروبات$") and is_SudoBot(msg.sender_user_id_, msg.chat_id_) and Abbas_Abs(msg) or text:match("^↫ القروبات ⌁$") and is_SudoBot(msg.sender_user_id_, msg.chat_id_) and Abbas_Abs(msg) then
...
local text =  [[
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
👨‍💻︙[المطور السورس](https://t.me/alone_kurdish)
👨🏻‍✈️︙[مساعد المطور](https://t.me/iH7SaN)
📡︙[قناه المطور](https://t.me/tweakjailbreak)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
]]
Dev_Abs(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
--     Source DevProx     --
if text:match("^رفع ادمن بالقروب$") and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ and Abbas_Abs(msg) or text:match("^رفع ادمن القروب$")  and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ and Abbas_Abs(msg) then
function promote_by_reply(extra, result, success)
local user_info_ = DevAbs:get(DevProx..'user:Name' .. result.sender_user_id_)
local absc9 = user_info_ if user_info_ then
HTTPS.request("https://api.telegram.org/bot" .. tokenbot .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=false")
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ['..absc9..']\n⌁︙تم رفعه ادمن في القروب', 1, 'md')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
if text:match("^تنزيل ادمن بالقروب$") and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ and Abbas_Abs(msg) or text:match("^تنزيل ادمن القروب$")  and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ and Abbas_Abs(msg) then
function promote_by_reply(extra, result, success)
local user_info_ = DevAbs:get(DevProx..'user:Name' .. result.sender_user_id_)
local absc9 = user_info_ if user_info_ then
HTTPS.request("https://api.telegram.org/bot" .. tokenbot .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙ادمن القروب ↫ ['..absc9..']\n⌁︙تم تنزيله ادمن من القروب', 1, 'md')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end 
...
if text and text:match("^رفع عضو$") then
function donky_by_reply(extra, result, success)
local user_info_ = DevAbs:get(DevProx..'user:Name' .. result.sender_user_id_)
local abs = 'bot:donky:'..msg.chat_id_
local absc9 = user_info_ if user_info_ then
if DevAbs:sismember(DevProx..abs, result.sender_user_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ['..absc9..']\n⌁︙هو عضو شرفع منه بعد😹💔', 1, 'md')
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ['..absc9..']\n⌁︙تم رفعه في قائمة الاعضاء', 1, 'md')
DevAbs:sadd(DevProx..abs, result.sender_user_id_)
end end end
...
--     Source DevProx     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل عضو$") then
function donky_by_reply(extra, result, success)
local user_info_ = DevAbs:get(DevProx..'user:Name' .. result.sender_user_id_)
local abs = 'bot:donky:'..msg.chat_id_
local absc9 = user_info_ if user_info_ then
if not DevAbs:sismember(DevProx..abs, result.sender_user_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ['..absc9..']\n⌁︙هو ليس عضو ليتم تنزيله', 1, 'md')
else
DevAbs:srem(DevProx..abs, result.sender_user_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ['..absc9..']\n⌁︙تم تنزيله من قائمة الاعضاء', 1, 'md')
end end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source DevProx     --
...
--     Source DevProx     --
if text == "المطايه" and Abbas_Abs(msg) or text == "الاعضاء" and Abbas_Abs(msg) then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "️⌁︙ارسل رابط القروب او معرف الدعم \n⌁︙ليتواصل معك المتابعين من خلاله ", 1, "md")
...
return false  end
if res.id_ then  
if tonumber(res.id_) == tonumber(1360161611) then
t = 'مبرمج السورس'
...
if tonumber(iduser) == tonumber(1360161611) then
t = 'مبرمج السورس'
...
text = '⌁︙القناة او القروب ليس له رتبه ' 
end
end
...
--     Source DevProx     --
if text == "تنظيف القروبات" and is_sudo(msg) and Abbas_Abs(msg) or text == "تنظيف المجموعات" and is_sudo(msg) and Abbas_Abs(msg) then 
...
local allmgs = DevAbs:get(DevProx.."bot:allmsgs")
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم تنظيف '..allmgs..' من رسائل القروبات', 'md')
...
DevAbs:del(DevProx..'bot:filters:'..msg.chat_id_)
DevAbs:del(DevProx..'bot:muted:'..msg.chat_id_)
local ABS_PROX = '⌁︙اهلا عزيزي ↫ '..abs_rank(msg)..' \n⌁︙تم حذف ↫ ❨ قائمة المنع • المحظورين • المكتومين • الادمنية • المميزين • الاعضاء ❩ بنجاح \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ABS_PROX, 15, string.len(msg.sender_user_id_))
end end
--     Source DevProx     --
...
if #donky ~= 0 then donkyt = 'الاعضاء • ' else donkyt = '' end
...
if DevAbs:get(DevProx..'fshar'..msg.chat_id_) then lock_fshar = '❬مفتوحه❭' else lock_fshar = '❬مقفله❭' end
...
--     Source DevProx     --
if text and text:match("^معلومات المجموعه$") and Abbas_Abs(msg) or text and text:match("^عدد الاعضاء$") and Abbas_Abs(msg) or text and text:match("^عدد القروب$") and Abbas_Abs(msg) or text and text:match("^عدد الادمنيه$") and Abbas_Abs(msg) or text and text:match("^عدد المحظورين$") and Abbas_Abs(msg) then
...
DevAbs:set(DevProx.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "@tweakjailbreak")) 
...
--     Source DevProx     --
if text and text:match("^تفعيل القروبات$") and is_leader(msg) then
...
if text and text:match("^تعطيل القروبات$") and is_leader(msg) then
local gps = DevAbs:smembers(DevProx.."bot:groups") or 0
local gps2 = DevAbs:smembers("ABS_PROX:addg"..bot_id) or 0
for i=1,#gps do
...
--     Source DevProx     --
if text == 'روابط القروبات' and Abbas_Abs(msg) or text == 'روابط المجموعات' and Abbas_Abs(msg) then
if not is_leader(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙للمطور الاساسي فقط ', 1, 'md')
else
...
local list = DevAbs:smembers(DevProx.."bot:groups")
local text = "(Source DevProx - سورس مصطفى كردش)\nΞ - File bot groups -\nΞ - ملف مجموعات البوت -\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(list) do
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "📜╿جيد , يمكنك الان ارسال جواب الرد\n🔛╽[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]\n✓" ,  1, "md")
...
‌‌‏┄─┅══┅─┄
🛡╽م1 » آوآمـر حماية المجموعه ‌‏
🔱╽م2 آوآمر آلتفعيل و آلتعطيل
👨‍💻╽م3 » اوامر الوضع للمجموعه
👨‍⚖️╽م4 » اوامر الرفع والتنزيل
🕹╽م5 » آوآمـر الحذف للمجموعة 
📟╽م6 » اوامر المطور
🛠╽الاعدادات » عدادات المجموعه
💯╽المطور » مطور البوت
⚜╽سورس » سورس البوت
‌‌‏┄─┅══┅─┄
 ‌‌‏💭│رآسـلني للآسـتفسـآر ☜[{ @alone_kurdish }](https://t.me/alone_kurdish)
]] 
...
🚫│قفل «» فتح ❬الملصقات)
🗂│قفل «» فتح ❬الملـــفات❭
🌄│قفل «» فتح ❬الصـــــــور❭
📽│قفل «» فتح ❬الفيـــديـــو❭
...
♻️│قفل «» فتح ❬التـــكــــرار❭
🙋‍♂|قفل «» فتح ❬ الهاشتــاك)
🖊│قفل «» فتح ❬التعــديــل❭
📌│قفل «» فتح ❬التثبيـــت❭
🔅│قفل «» فتح❬الاشـــعارات❭
🔓│قفل «» فتح ❬الكلايـــش❭
🏹│قفل «» فتح ❬الشبكـــات❭
⚜️│قفل «» فتح ❬المواقـــع❭
🍿│قفل «» فتح ❬الفشـــار ❭
🥏│قفل «» فتح ❬الكفــــــر❭
🛐│قفل «» فتح ❬الطائفيـه❭
📵╿قفل«» فتح ❬الكـــــــل❭
...
2↫❬اوامر حمايـه اخرى❭
┄─┅═ـ═┅─┄
🔒│قفل «» فتح ❬الفارسيـــه بالطـــرد❭
🏌‍♂│قفل «» فتح ❬البوتـــات بالطـــــرد❭
🧑🏻‍🦯│قفل «» فتح ❬البوتـــات بالتقييـــد❭
┄─┅══┅─┄
💭│ راسلني للاستفسار 💡↭
[@alone_kurdishl](https://t.me/alone_kurdish)
]]
Dev_Abs(msg.chat_id_, msg.id_, 1, (help or text), 1, 'md')
end
...
⬅️│اسم بوتك + -ايدي المجموعه «» ❬لطرد البوت❭
♾│كشف + -ايدي المجموعه «» ❬معلومات عن المجموعه❭
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙جاري تحديث سورس مصطفى الكردي', 1, 'md') 
os.execute('rm -rf DevProx.lua') 
os.execute('wget https://raw.githubusercontent.com/Mkurdiish/mustafa/master/DevProx.lua') 
...
------------------------------------------------
-- This Source Was Developed By (ABS) @alone_kurdish.--
--   This Is The Source Channel @alone_kurdish .   --
--                - alone_kurdish -                 --
--        -- https://t.me/alone_kurdish --         --
------------------------------------------------ 
